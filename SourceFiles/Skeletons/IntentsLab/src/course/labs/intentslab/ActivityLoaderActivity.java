...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		Intent mExplicitIntent = new Intent(ActivityLoaderActivity.this, ExplicitlyLoadedActivity.class);
		
		// TODO - Start an Activity using that intent and the request code defined above
		startActivityForResult(mExplicitIntent, GET_TEXT_REQUEST_CODE);
	...
	private void startImplicitActivation() {
		...
		chooserIntent = Intent.createChooser(baseIntent, "View link via");
